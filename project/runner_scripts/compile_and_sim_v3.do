...
puts "╔════════════════════════════════════════════════════════════════╗"
puts "║  Compiling Scratchpad Memory with 1-Cycle Latency (v3)        ║"
puts "╚════════════════════════════════════════════════════════════════╝"
puts ""
...
puts "Compiling: tb_scratchpad_memory_v3.sv (1-cycle latency testbench)"
vlog -sv -work $work_dir "$proj_dir/tb_scratchpad_memory_v3.sv" 2>&1
...
puts "╔════════════════════════════════════════════════════════════════╗"
puts "║    Running Simulation - 1-Cycle Latency Testbench (v3)       ║"
puts "╚════════════════════════════════════════════════════════════════╝"
puts ""
